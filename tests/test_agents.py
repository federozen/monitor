...
class EditorialAgentTests(unittest.TestCase):
    ...
    def test_covered_equal_is_not_recommended_as_new(self):
        ...
        self.assertEqual(rec["coverage_status"], "YA_CUBIERTO")
    ...
    def test_discovery_prioritizes_rare_international_story(self):
        ...
        self.assertGreaterEqual(discoveries[0]["score"], 50)
    ...
    def test_discovery_returns_best_candidates_even_below_strong_threshold(self):
        ...
        self.assertIn(discoveries[0]["status"], {"HALLAZGO FUERTE", "HALLAZGO", "CANDIDATO PARA EXPLORAR"})
    ...
    def test_briefing_reports_only_real_delta(self):
        ...
        self.assertIn("pasó de 2 a 4", changes[0]["what_changed"])
        self.assertIn("QUÉ CAMBIÓ PARA AGREGAR", summary["plain_text"])
    ...
    def test_report_separates_operations_and_findings(self):
        ...
        discoveries = [{
            ...
            "score": 80, "value_argentina": 70, "reason": "rareza", "notify": True, "status": "HALLAZGO FUERTE",
        }]
